	...
	<section>
		<div class="container mt-5">
			<div class="row justify-content-center">
				<div class="col-md-6">
					<h3 class="mb-3">기사 수정</h3>
					<form action="update-news" method="post">
						<input type="hidden" name="p_no" value="${news.p_no}">
						<div class="mb-3">
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control" id="writer" name="p_writer" value="${news.p_writer}" readonly>
						</div>
