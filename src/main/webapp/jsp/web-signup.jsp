		...
		<div class="input-form-backgroud row">
			<div class="input-form mx-auto"
				...
				<form method="post" action="signupProcess.do" name="joinForm"
						...
						<div class="row">
							<div class="col-4">
								<input type="text" class="form-control" name="birthdate"
									placeholder="901208" value="" maxlength="6" pattern="[0-9]{6}"
									required>
							</div>
							<div class="col-1">-</div>
							<div class="col-2">
					...
					<div class="col-6 mb-3">
						<label for="phone">연락처</label> <select name="telecom">
					...
					<div class="col-10 mb-3">
						<input type="button" class="btn btn-secondary"
    						...
    						<input type="text" class="form-control" id="extraAddress" placeholder="상세주소">
