...
--SELECT * FROM B_BOARD;
--
--SELECT * FROM B_BOARD WHERE P_WRITER = 'j.hyun758' ORDER BY P_NO DESC;
--DELETE B_BOARD WHERE P_NO = '35';
--COMMIT;
--
--SELECT * FROM B_TRANSACTION ORDER BY T_TRANSACTION_NO DESC;
--SELECT * FROM B_TRANSACTION WHERE T_IN_OUT='출금' ORDER BY T_TRANSACTION_NO DESC;
...
--UPDATE B_USER_ACCOUNT SET USER_ID='aaaa' WHERE ACCOUNT_NO='0758-43201113';

--UPDATE B_TRANSACTION SET T_TO_MEMO='현종이' WHERE T_TRANSACTION_NO='230702113135-163';


--SELECT UA.ACCOUNT_NO, DE.*
--FROM B_USER_ACCOUNT UA
--JOIN B_DEPOSIT DE ON UA.D_PRODUCT_CODE = DE.D_PRODUCT_CODE
--WHERE UA.ACCOUNT_NO = '0758-12976295';




--은행정보 우선 등록
INSERT INTO B_BANK_INFO VALUES('0758', '하리은행');
