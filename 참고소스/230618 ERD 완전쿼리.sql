...
CREATE TABLE "B_TRANSACTION" (
	...
	"T_SENDER_BANK_CODE"	VARCHAR2(200)		NOT NULL,
	"T_SENDER_ACCOUNT_NO"	VARCHAR2(200)		NOT NULL,
	"T_RECEIVER_BANK_CODE"	VARCHAR2(200)		NOT NULL,
	"T_RECEIVER_ACCOUNT_NO"	VARCHAR2(200)		NOT NULL,
