...
--DROP TABLE "B_NOTICE_FNQ" CASCADE CONSTRAINTS;
--DROP TABLE "B_QNA" CASCADE CONSTRAINTS;
--DROP TABLE "B_USER_ADDRESS" CASCADE CONSTRAINTS;
--DROP TABLE "B_NOTICE_IMG" CASCADE CONSTRAINTS;
--DROP TABLE "B_OPENBANK" CASCADE CONSTRAINTS;
