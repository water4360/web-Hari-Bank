...
CREATE TABLE "B_TRANSACTION" (
	"T_TRANSACTION_NO"	VARCHAR2(50)		NOT NULL,
...
--ALTER TABLE "B_TRANSACTION" ADD COLUMN T_PREVIOUS_BALANCE NUMBER;

COMMENT ON COLUMN "B_TRANSACTION"."T_TYPE" IS '오픈뱅킹/당행/타행';

COMMENT ON COLUMN "B_TRANSACTION"."T_TO_RECEIVER" IS '7자이내';
...
CREATE TABLE "B_USER_ACCOUNT" (
	...
	"USER_ID"	VARCHAR2(200)		NOT NULL,
	"B_BANK_CODE"	VARCHAR2(200)		NOT NULL,
	"ACCOUNT_STATUS"	VARCHAR2(200)	DEFAULT '아직 구현 안됨Activated'	NULL
);

COMMENT ON COLUMN "B_USER_ACCOUNT"."ACCOUNT_PASSWORD" IS '숫자4자리';

COMMENT ON COLUMN "B_USER_ACCOUNT"."ACCOUNT_STATUS" IS 'Activated/Deactivated';
