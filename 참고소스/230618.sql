INSERT INTO B_USER_INFO(USER_ID, USER_PASSWORD, KOR_NAME, BIRTHDATE, GENDER, TELECOM, PHONE_NO, EMAIL, SIGNUP_TYPE, REG_DATE) 
      VALUES('aaaa', '1111', '테스트', '901208', '2', 'KT', ?, ?, 'web', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'));

SELECT * FROM B_USER_INFO;

SELECT * FROM B_USER_ADDRESS;

ALTER TABLE B_USER_INFO RENAME COLUMN REG_DATE TO REG_DATETIME;
ALTER TABLE B_USER_ADDRESS RENAME COLUMN DEATIL_ADDRESS TO DETAIL_ADDRESS;
COMMIT;
...
INSERT INTO B_USER_AUTHORITY(ROLE_CODE, ROLE_NAME, USER_ID) VALUES('H1', '브론즈', 'aaaa');
