...
SELECT SEQ_L_BOARD_NO.NEXTVAL FROM DUAL;


--230813
--답글용
SELECT * FROM B_BOARD;
CREATE SEQUENCE SEQ_B_BOARD_NO START WITH 41 NOCACHE;
CREATE SEQUENCE SEQ_B_REPLY_NO NOCACHE;

--답글용 원글정보
SELECT TITLE, REF, LEV, STEP FROM B_BOARD WHERE NO = 30;
--답글 등록
INSERT INTO B_BOARD(NO, TITLE, WRITER, CONTENT, LEV, STEP)
		VALUES(SEQ_B_REPLY_NO.NEXTVAL, '230816 답글예시', 'j.hyun758', '내용예시', 1, 1);
COMMIT; 
